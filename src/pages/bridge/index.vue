        ...
        <div class="main-content">
            ...
            <div class="confirm-box" v-else-if="bridgeStep === 2">
                ...
                <div class="confirm-item" style="margin-bottom: 22px;">
                    <div class="confirm-item-top-group">
                        <div class="item-left">
                            <span class="left-txt">Received</span><span class=""></span>
                        </div>
                        <div class="item-right">
                ...
                <div class="confirm-item" style="margin-bottom: 22px;">
                    ...
                    <div class="descBottom">
                        <div style="margin-bottom: 1rem;">
                            ...
                            <span
                                style="margin-left: 0.7rem; margin-right: 0.7rem; color: rgb(223, 46, 45); width: 90px; display: inline-block; text-align: center;">
                                {{ amount }} {{ coinChoose.name }}
                            </span>
                            To
                            <span class=""
                                style="margin-left: 0.7rem; color: rgb(223, 46, 45); width: 90px; display: inline-block; text-align: center;">
